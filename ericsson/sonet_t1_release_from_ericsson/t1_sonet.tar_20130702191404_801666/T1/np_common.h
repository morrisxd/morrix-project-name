...
typedef struct STRU_STM1_CFG_INFO_TAG
{
    ...
    u32 physicalLayer; /*NPU_PHYSICAL_SDH OR NPU_PHYSICAL_SONET*/
}STRU_STM1_CFG_INFO;
...
extern void np_set_ufe4_alarm_info(WP_U32 LinePort, WP_U32 AlarmCategory, WP_U32 IsAsserted);
extern void np_set_ufe4_E1T1_aralm_info(WP_U8 Stm1, WP_U16 LineIndex, WP_U32 AlarmCategory, WP_U32 IsAsserted);
