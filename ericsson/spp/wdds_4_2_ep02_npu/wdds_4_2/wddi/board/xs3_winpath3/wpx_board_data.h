...
WP_status WPX_BoardXgiConfig(WP_U32 wpid, WP_port port);
...
#define WPX_FPGA_MUX_SELECT2_UPI1_UPI2_62M  0x1b
#define WPX_FPGA_MUX_SELECT2_UPI1_UPI2_104MHZ 0x7
#define WPX_FPGA_MUX_SELECT2_UPI3_62M  0x24
...
#define WPX_FPGA_BRG_C_INPUT_MASK      0x38
...
#define WPX_FPGA_DIP_SWITCH_BOARD_TYPE_MASK 0x10
#define WPX_FPGA_DIP_SWITCH_REVISION_MASK 0x20
...
#define WPX_SERIAL_CONTROL_UFE4_RESET_UPI3_MASK   0x20
#define WPX_SERIAL_CONTROL_UFE4_PROGRAM_UPI3_MASK 0x10

#define WPX_SERIAL_CONTROL_UFE4_RESET_UPI2_MASK   0x8
#define WPX_SERIAL_CONTROL_UFE4_PROGRAM_UPI2_MASK 0x4

#define WPX_SERIAL_CONTROL_UFE4_RESET_UPI1_MASK   0x2
#define WPX_SERIAL_CONTROL_UFE4_PROGRAM_UPI1_MASK 0x1

#define WPX_SERIAL_UFE4_GPIO_IO_OFFSET 0x10e00
#define WPX_SERIAL_UFE4_GPIO_VAL_OFFSET 0x10e04
#define WPX_SERIAL_UFE4_GPIO_7_MASK 0x80
#define WPX_SERIAL_UFE4_GPIO_8_9_MASK 0x300

#define WP_MII_MGMT_DEV_TYPE 1
#define WPX_INTERRUPT_EINT3 0xb
...
#if 1 // XALYO
#define WPX_PORT_MODE_ATM  0
#define WPX_PORT_MODE_POS  0
#define WPX_PORT_MODE_FR   0
#define WPX_PORT_MODE_STM1 0
#define WPX_PORT_MODE_STM4 0
#define WPX_PORT_MODE_ETH  1

#define WPX_PORT_LED_OFF   0
#define WPX_PORT_LED_ON    1

WP_status WPX_PortLedSet(WP_U32 wpid, WP_U8 mode, WP_U32 port);
WP_status WPX_PortModeSet(WP_U32 wpid, WP_U8 mode, WP_U32 port);
WP_status WPX_PortModeGet(WP_U32 wpid, WP_U8 *pmode, WP_U32 port);
WP_status WPX_PhyRegRead(WP_U32 wpid, WP_U32 reg, WP_U16 *val);
WP_status WPX_PhyRegWrite(WP_U32 wpid, WP_U32 reg, WP_U16 val);
#endif
