...
{
   /* 0 - WPX_CONFIGURE_DEFAULT_CHECKIN  */
   ...
   {
      {
         ...
         /* pins 216-223 */0xFFFF0000
       }
   },
   /* 1 - WPX_CONFIGURE_CHECKIN_TDI_16             */
   /*  tdi 1 - 16 */
   {
      {
         ...
         /* pins 216-223 */0x00FF7700
      }
   },
   /* 2 - WPX_CONFIGURE_UFE_UPI2_TDM               */
   {{0}},
   /* 3 - WPX_CONFIGURE_TDI_16_UPI1                */
   {{0}},
   /* 4 - WPX_CONFIGURE_2UPI_2XGI_6SGMII2G         */
   ...
   {
      {
         ...
         /* pins 208-215 */0x44111111,
         /* pins 216-223 */0xFFFF7700
      }
   },
   /* 5 - WPX_CONFIGURE_1UPI_1XGI_4GMII_8SGMII     */
   ...
   /* 6 - WPX_CONFIGURE_1XGI_6RGMII_6SGMII    */
   ...
   /* 7 - WPX_CONFIGURE_1UPI_1XGI_6RTBI_6SGMII     */
   ...
   /* 8 - WPX_CONFIGURE_1XGI_6SMII_6SGMII     */
   ...
   {
      {
         ...
         /* pins 208-215 */0x11111111,
         /* pins 216-223 */0xFFFF7700
      }
   },
   /* 9 - WPX_CONFIGURE_2RMII_8TDI_1XGI_10SGMII  */
   ...
   /* 10 - WPX_CONFIGURE_8TDI_1UPI_1XGI_10SGMII  */
   ...
   {
      {
         ...
         /* pins 200-207 */0x44444444,
         /* pins 208-215 */0x44FFFFFF,
         /* pins 216-223 */0x00FFFF00
      }
   },
   /* 11 - WPX_CONFIGURE_2UPI_1XGI_10SGMII  */
   ...
   /* 12 - WPX_CONFIGURE_2UPI_1XGI_10SGMII_UFE4  */
   /* upi 1 and 2, pos level 2 256 phys 32 bit*/
   {
      {
         /* pins 000-007 */0x44444444,
         ...
         /* pins 088-095 */0x44444444,
         /* pins 096-103 */0x44444444,
         /* pins 104-111 */0xff444449,
         /* pins 112-119 */0x99444444,
         /* pins 120-127 */0x44444444,
         /* pins 128-135 */0x44444444,
         /* pins 136-143 */0x44444444,
         /* pins 144-151 */0x44444444,
   ...
   /* 13 - WPX_CONFIGURE_2UPI_16bit_1XGI_10SGMII  */
   /* upi 1 and 2, pos level 2 256 phys 16 bit*/
   {
      {
         /* pins 000-007 */0x44444444,
         /* pins 008-015 */0x44444444,
   ...
   /* 14 - WPX_CONFIGURE_BRG_MUX*/
   {{0}},
   /* 15 - WPX_CONFIGURE_PPS_FCLK_SELECT*/
   {{0}},
   /* 16 - WPX_CONFIGURE_SMA_DIRECTION*/
   {{0}},
   /* 17 - WPX_CONFIGURE_2SGMII_2SGMII2G_16TDI*/
   {
      {
         /* pins 000-007 */0x88888888,
         /* pins 008-015 */0x88888888,
   ...
   /* 18 - WPX_CONFIGURE_2UPI_1XGI_10SGMII_UPI_CLK_100M  */
   /* upi 1 and 2, pos level 2 256 phys 32 bit*/
   {
      {
         /* pins 000-007 */0x44444444,
   ...
   /* 19 - WPX_CONFIGURE_6SGMII_1SGMII2G_2SMII     */
   /* enet 2, 4 - SMII or SS-SMII */
   {
      {
         /* pins 000-007 */0xFFFFFFFF,
         /* pins 008-015 */0xFFFFF111,
         /* pins 016-023 */0x11111111,
         /* pins 024-031 */0x11111111,
         /* pins 032-039 */0x11FFFFFF,
         /* pins 040-047 */0xFFFFFFF1,
         /* pins 048-055 */0x11111111,
         /* pins 056-063 */0x11111111,
         /* pins 064-071 */0x1111FFFF,
         /* pins 072-079 */0xFFFFFFFF,
         /* pins 080-087 */0xFFFFFFFF,
         /* pins 088-095 */0xFFFFFFFF,
         /* pins 096-103 */0xFFFFFFFF,
         ...
         /* pins 192-199 */0xFFFFFFFF,
         /* pins 200-207 */0xFFFFFFFF,
         /* pins 208-215 */0xFFFFFFFF,
         /* pins 216-223 */0xFFFFFF00
      }
   },
/* 20 - WPX_CONFIGURE_2UPI_L3_2XGI_6SGMII*/
/*upi1 and upi2 32 bit level3 */
   {
      {
         /* pins 000-007 */0x55555555,
         /* pins 008-015 */0x55555555,
         /* pins 016-023 */0x55555555,
         /* pins 024-031 */0x55555555,
         /* pins 032-039 */0x55555555,
         /* pins 040-047 */0x55555555,
         /* pins 048-055 */0x55555555,
         /* pins 056-063 */0x55555555,
         /* pins 064-071 */0x55555555,
         /* pins 072-079 */0x55555555,
         /* pins 080-087 */0x55555555,
         /* pins 088-095 */0x55555555,
         /* pins 096-103 */0x55555555,
         /* pins 104-111 */0x55555555,
         /* pins 112-119 */0x55555555,
         /* pins 120-127 */0x55555555,
         /* pins 128-135 */0x55555555,
         /* pins 136-143 */0x55555555,
         /* pins 144-151 */0x55555555,
         /* pins 152-159 */0x55555555,
         /* pins 160-167 */0x55555555,
         /* pins 168-175 */0x55555555,
         /* pins 176-183 */0x55555555,
         /* pins 184-191 */0x55555555,
         /* pins 192-199 */0x55555555,
         /* pins 200-207 */0x55555555,
         /* pins 208-215 */0x55FFFFFF,
         /* pins 216-223 */0xFFFFFF00
      }
   },
   /* 21 - WPX_CONFIGURE_UPI1_TDI8_16_10SGMII*/
   {{0}},
   /* 22 - WPX_CONFIGURE_2XGI_6SGMII*/
   {{0}},
   /* 23 - WPX_CONFIGURE_2UPI_2XGI_6SGMII2G_UFE448          */
   /* upi 1 - pos level 2 32 bit master 256 phys*/
   /* upi 2 - pos level 2 32 bit master 256 phys*/
   {
      {
         ...
         /* pins 088-095 */0x44444444,
         /* pins 096-103 */0x44444444,
         /* pins 104-111 */0x44444499,/*the two 9's are for defining sp110 and sp111 as GPIO*/
         /* pins 112-119 */0x99444444,/*the two 9's are for defining sp112 and sp113 as GPIO*/
         /* pins 120-127 */0x44444444,
         /* pins 128-135 */0x44444444,
         /* pins 136-143 */0x44444444,
         /* pins 144-151 */0x44444444,
   ...
   /* 24 - WPX_CONFIGURE_UPI3_UFE412          */
   /* upi 3 - pos level 2 32 bit master 256 phys*/
   {
      {
         /* pins 000-007 */0xFFFFFFFF,
         /* pins 008-015 */0xFFFFFFFF,
         ...
         /* pins 048-055 */0xFFFFFFFF,
         /* pins 056-063 */0xFFFFFFFF,
         /* pins 064-071 */0xFFFF7788,
         /* pins 072-079 */0x88888888,
         /* pins 080-087 */0x88888888,
         /* pins 088-095 */0x88888888,
         /* pins 096-103 */0x88888888,
         /* pins 104-111 */0x8888888F,
         /* pins 112-119 */0xFFFFF888,
         /* pins 120-127 */0x88888888,
         /* pins 128-135 */0x88888888,
         /* pins 136-143 */0x8888FFFF,
         /* pins 144-151 */0xFFFFFFFF,
         /* pins 152-159 */0xFFFFFFFF,
         /* pins 160-167 */0xFFFFFFFF,
         /* pins 168-175 */0xFFFFFFFF,
   ...
   // XALYO
   /* WPX_CONFIGURE_XS_1UPI_10SGMII 25*/
   /* UPI1, level2 16 bit 256 phys*/
   {
      {
         ...
         /* pins 008-015 */0x44444444,
         /* pins 016-023 */0x44444444,
         /* pins 024-031 */0x44FFFF44,
         /* pins 032-039 */0x44444444,
         /* pins 040-047 */0x444444FF,
         /* pins 048-055 */0x44444444,
         /* pins 056-063 */0x44FFFFFF,
         /* pins 064-071 */0xFFFFFFFF,
         /* pins 072-079 */0xFFFFFFFF,
         /* pins 080-087 */0xFFFFFFFF,
         /* pins 088-095 */0xFFFFFFFF,
         ...
         /* pins 200-207 */0xFFFFFFFF,
         /* pins 208-215 */0xFF111111,
         /* pins 216-223 */0x00007700
       }
   },
   /* WPX_CONFIGURE_XS_1UPI_1XGI_S2_6SGMII 26*/
   /* UPI1, level2 16 bit 256 phys*/
   {
      {
   ...
   /* WPX_CONFIGURE_XS_1UPI_1XGI_S3_6SGMII 27*/
   /* UPI1, level2 16 bit 256 phys*/
   {
      {
   ...
   /* WPX_CONFIGURE_XS_1UPI_2XGI_2SGMII 28*/
   /* UPI1, level2 16 bit 256 phys*/
   {
      {
   ...
   /* WPX_CONFIGURE_XS_1POS_10SGMII 29*/
   /* UPI1, POS-PHY 16 bit */
   {
      {
   ...
   /* WPX_CONFIGURE_XS_1POS_1XGI_S2_6SGMII 30*/
   /* UPI1, POS-PHY 16 bit */
   {
      {
   ...
   /* WPX_CONFIGURE_XS_1POS_1XGI_S3_6SGMII 31*/
   /* UPI1, POS-PHY 16 bit */
   {
      {
   ...
   /* WPX_CONFIGURE_XS_1POS_2XGI_2SGMII 32*/
   /* UPI1, POS-PHY 16 bit */
   {
      {
   ...
   {
      {
         ...
         /* pins 040-047 */0x44444444,
         /* pins 048-055 */0x44444444,
         /* pins 056-063 */0x4444FFFF,
         /* pins 064-071 */0x44FF44FF,
         /* pins 072-079 */0xFFFFFFFF,
         /* pins 080-087 */0xFFFFFFFF,
         /* pins 088-095 */0xFFFFFFFF,
         /* pins 096-103 */0xFFFFFFFF,
         ...
         /* pins 192-199 */0xFFFFFFFF,
         /* pins 200-207 */0xFFFFFFFF,
         /* pins 208-215 */0xFF11F1FF,
         /* pins 216-223 */0x00007F00
       }
   },
   /* WPX_CONFIGURE_XS_1UPI_2SGMII 34*/
   {
      {
   ...
   /* WPX_CONFIGURE_XS_1POS_2SGMII 35*/
   {
      {
         /* pins 000-007 */0x44444444,
         /* pins 008-015 */0x44444444,
...
WP_status WPX_PinMuxTdiDriveStrength(WP_U32 wpid)
{
   ...
   /* set PM_SP_CTRL_000_001 - change the Drive Strength of SP000 (TDI7_TX_CLK & TDI7_TX_SYNC) to 4mA */
   WPI_REG_SET(pinmux_reg->pinmux_pad_control[WPX_PINMUX_TDI7_CLK_SYNC_PAD/2], reg);
   /* set PM_SP_CTRL_208_209 - change the Drive Strength of SP009 (TDI7_TX_CLK & TDI7_TX_SYNC) to 4mA */
...
{
   wpx_pinmux *pinmux_reg;
   WP_U32 mux_reg_value;
   WP_U32 start_pad_reg, end_pad_reg, index;

   pinmux_reg = WPX_PinmuxBaseGet(wpid);

   if (level == WP_UPI_LEVEL2)
   {
      mux_reg_value = WPX_PINMUX_UPI_LEVEL2_REG_VALUE;
   }
   else if (level == WP_UPI_LEVEL3)
   {
      mux_reg_value = WPX_PINMUX_UPI_LEVEL3_16_32BIT_REG_VALUE;
   }
   else
   {
   ...
   if (port == WP_PORT_UPI1)
   {
      start_pad_reg = WPX_PINMUX_UPI1_START_REG;
      end_pad_reg = WPX_PINMUX_UPI1_END_REG;
   }
   else if (port == WP_PORT_UPI2)
   {
      start_pad_reg = WPX_PINMUX_UPI2_START_REG;
      end_pad_reg = WPX_PINMUX_UPI2_END_REG;
   }
   else
   {
      return WPI_ERROR(WP_ERR_UNSUPPORTED);
   ...
   for (index = start_pad_reg; index <= end_pad_reg; index++)
   {
      WPI_MEM_SET(pinmux_reg->pinmux_control[index], mux_reg_value);
   }
