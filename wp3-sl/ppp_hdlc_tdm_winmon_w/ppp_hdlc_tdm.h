...
#define APP_MAX_DEV_TDM	PQBLOCK_SIZE
#define APP_MAX_PORT_TDM PQBLOCK_SIZE
#define APP_MAX_FLOW_AGG_TDM PQBLOCK_SIZE
...
{
   /* atm_limits*/ {0},
   /* pkt_limits*/ {64,64,APP_MAX_TDM_PORTS,PQBLOCK_SIZE,0},
   /* trans_limits */ {{0},{0}},
   /* slot */      tdm_slots,
...
WP_handle 				h_port_tdm[APP_MAX_PORT_TDM];
WP_handle 				h_dev_tdm[APP_MAX_DEV_TDM];
...
WP_handle               h_flow_agg_tdm[PQBLOCK_SIZE];
WP_handle               h_iw_sys_bridge1, h_iw_sys_bridge2;
WP_handle               h_iw_sys_pppsw;
WP_handle               h_learningflow_enet1;
WP_handle               h_bridge1_dfcflow1[PQBLOCK_SIZE][APP_MAX_TDM_PORTS];
WP_handle               h_bridge2_dfcflow[PQBLOCK_SIZE][APP_MAX_TDM_PORTS],h_bridge2_dfcflow_control,h_bridge2_dfcflow_lcp;
WP_handle               h_bridge1_filter1,h_bridge2_filter[3];
WP_handle               h_port_iwhost,h_dev_iwhost;
WP_handle               h_bridge1_bport_enet1, h_bridge1_bport_tdm[APP_MAX_PORT_TDM];
WP_handle               h_bridge2_bport_enet2, h_bridge2_bport_tdm[APP_MAX_PORT_TDM];
WP_handle               h_flow_agg_pppsw_link[PQBLOCK_SIZE];
WP_handle               h_flow_agg_lcp, h_flow_agg_control,h_flow_agg_enet2[APP_MAX_FLOW_AGG_TDM];
...
WP_handle               h_tdm_rx[APP_MAX_CHANNEL],h_tdm_tx[PQBLOCK_SIZE][APP_MAX_TDM_PORTS];// each PQ-block will have n channel
...
WP_tag tag_bridge1_bport_tdm[APP_MAX_PORT_TDM];
WP_tag tag_bridge2_bport_tdm[APP_MAX_PORT_TDM ];
WP_tag tag_rport_tdm[APP_MAX_TDM_PORTS];
WP_tag tag_rport_enet2;
WP_tag tag_agg_enet2[APP_MAX_FLOW_AGG_TDM];
...
WP_tag tag_agg_tdm[APP_MAX_FLOW_AGG_TDM];
WP_tag tag_agg_pppsw[PQBLOCK_SIZE];
WP_tag tag_agg_lcp, tag_agg_control;
WP_boolean debug_on = WP_FALSE;

WP_iw_agg_bridging iw_agg_tdm_param[PQBLOCK_SIZE];
WP_iw_agg_ppp_switching iw_agg_ppp_switching_param[APP_MAX_PORT_TDM];
WP_iw_agg_directmap iw_agg_directmap_cfg_param[APP_MAX_FLOW_AGG_TDM];
