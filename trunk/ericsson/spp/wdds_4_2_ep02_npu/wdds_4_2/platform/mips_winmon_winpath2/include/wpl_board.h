...
#define WPL_INTERNAL_BUS_RAM_BASE (0x1d000000+WPL_INT_MEM_RAM_OFFSET)

#define WPL_INTERNAL_BUS_RIF_SIZE   0x00040000
#define WPL_INTERNAL_BUS_RIF_BASE   (0x1d000000+WPL_INT_MEM_RIF_OFFSET)
...
#define WPL_HOST_BUS_SIZE   0x01800000
#define WPL_HOST_BUS_ADDR   0x02000000
