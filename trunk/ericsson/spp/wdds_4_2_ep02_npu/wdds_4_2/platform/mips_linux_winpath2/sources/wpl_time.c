...
/*****************************************************************************
 *
 * File: platform/mips_linux_winpath2/sources/wpl_time.c
 *
...
#define WPL_TIME_PRESCALAR  (wpl_rif_base[0] + 0x1da0)
#define WPL_TIME_HIGH       (wpl_rif_base[0] + 0x1da4)
#define WPL_TIME_LOW        (wpl_rif_base[0] + 0x1da8)
...
WP_U32 WPL_TimeInit(void)
{
   ...
   {
      WPLI_BusesRifBaseGet(&wpl_rif_base[0]);
   }
