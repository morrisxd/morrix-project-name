...
#define WPL_TA_SEMAPHORE_UNUSED_1          5
...
/* Under WP2 the key should have HW off and SHARED off, so the key in only the num */
#define WPL_WDDI_LOCK_KEY      WPL_LOCK_KEY_CREATE(WPL_SW_LOCK,      \
                                                   WPL_PRIVATE_LOCK, \
                                                   0, 78704)
