...
#include "wpx_ufe2_data.h"
#endif

wufei_mem_space ufe_mem_space[APP_UFE_MEM_SPACE_CONNECTORS] = {
   {APP_UFE_BASE_UFE0_UPI1, APP_UFE_BASE_TEMUX0_UPI1, APP_UFE_BASE_ARROW0_UPI1},
   {APP_UFE_BASE_UFE0_UPI2, APP_UFE_BASE_TEMUX0_UPI2, APP_UFE_BASE_ARROW0_UPI2}
};
