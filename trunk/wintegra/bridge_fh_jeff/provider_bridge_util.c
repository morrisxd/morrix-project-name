...
void WPE_CreatePceInterface(WP_handle iw_sys)
{
        ...
        pce_interface = WP_PceInterfaceCreate(WP_PCE_IF_TYPE_PKT_RX_CHANNEL, &pce_if_params);
        App_TerminateOnError(pce_interface,"WP_PceInterfaceCreate()",__LINE__);
...
void WPE_CreateReservedMacPceRule(WP_U8 portid, WP_U8 *mac)
{
        ...
        rule_cfg.match_result[0].result_type = WP_PCE_RESULT_FLOW_AGG;
        rule_cfg.match_result[0].param.flow_agg.flow_aggregation = default_agg_host;
        ...
        WP_policer_v2 pv2 =
                {
                        ...
                        /* color_mode */ WP_POLICER_COLOR_BLIND, //WP_POLICER_COLOR_AWARE, //
