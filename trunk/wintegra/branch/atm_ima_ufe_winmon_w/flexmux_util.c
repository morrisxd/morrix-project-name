...
WP_S32 WTI_FlexmuxInit (WP_U32 upi_index, WP_U8 flexmux_id, WTI_flexmux_physical_conf flexmux_hw_config, WP_U8 flexmux_mode, WPX_UFE_FRAMER_WUFE_line_transf_type vc_3_4, WTI_Flexmux_global_setup * flexmux_cfg)
{
    ...
    if (flexmux_hw_config != WT_FLEXMUX_UFE_412_1_PORT_OC12 &&
        ...
        flexmux_hw_config != WT_FLEXMUX_UFE_448_4_PORTS_OC12 && flexmux_hw_config != WT_FLEXMUX_UFE_448_16_PORTS_OC3 && flexmux_hw_config != WT_FLEXMUX_UFE_448_4_PORTS_OC12_PLUS_4_PROTECTION && flexmux_hw_config != WT_FLEXMUX_UFE_412_4_PORTS_OC3_CARD_PROTECTION_MASTER && flexmux_hw_config != WT_FLEXMUX_UFE_412_4_PORTS_OC3_CARD_PROTECTION_SLAVE)
        WTI_FlexmuxTerminateOnError ("Invalid flexmux_hw_config !", 0);

    if (flexmux_mode != WPX_UFE_FRAMER_DEVICE_MODE_SONET && flexmux_mode != WPX_UFE_FRAMER_DEVICE_MODE_SDH)
    ...
    else if (flexmux_hw_config == WT_FLEXMUX_UFE_412_4_PORTS_OC3 || flexmux_hw_config == WT_FLEXMUX_UFE_412_4_PORTS_OC3_CARD_PROTECTION_MASTER || flexmux_hw_config == WT_FLEXMUX_UFE_412_4_PORTS_OC3_CARD_PROTECTION_SLAVE)
    {
        if (flexmux_mode == WPX_UFE_FRAMER_DEVICE_MODE_SONET)
        {
    ...
    else if (flexmux_hw_config == WT_FLEXMUX_UFE_448_16_PORTS_OC3)
    {
        ...
        max_line_ports = 16;
        line_increment = 1;
        wti_flexmux_build_personality = WPX_UFE_FRAMER_BUILD_PERSONALITY_16_OC3;
    }
    ...
    status = WPX_UFE_FRAMER_FlexmuxInit (flexmux_cfg->flexmux_id, upi_index);
    ...
    /* service the mailboxes in a separate thread */
    {
        ...
        if (mailbox_thread_id == 0)
            WPL_ThreadInit (&mailbox_thread_id, (void *(*)(void *)) WPX_UFE_FRAMER_FlexmuxServiceMailbox, (void *) thread_params);
    }
...
#define WPL_THREAD_LOCK_KEY WPL_LOCK_KEY_CREATE(WPL_HW_LOCK, WPL_PRIVATE_LOCK, 7, 0)
        ...
        WPL_ThreadInit (&alarm_and_pm_thread_id, (void *(*)(void *)) process_framer_task_list, (void *) thread_params);
    }

    /* set the Flexmux device build personality */
    status = WPX_UFE_FRAMER_FlexmuxSetBuildPersonality (flexmux_cfg->flexmux_id, wti_flexmux_build_personality, upi_index);
    ...
    if (wti_flexmux_build_personality == WPX_UFE_FRAMER_BUILD_PERSONALITY_4_PLUS_4_OC3_OC12 ||
        wti_flexmux_build_personality == WPX_UFE_FRAMER_BUILD_PERSONALITY_8_PLUS_8_OC3 || wti_flexmux_build_personality == WPX_UFE_FRAMER_BUILD_PERSONALITY_1_PLUS_1_OC3_OC12 || wti_flexmux_build_personality == WPX_UFE_FRAMER_BUILD_PERSONALITY_2_PLUS_2_OC3 || wti_flexmux_build_personality == WPX_UFE_FRAMER_BUILD_PERSONALITY_4_PLUS_4_OC3)
    {
        ...
        else if (flexmux_mode == WPX_UFE_FRAMER_DEVICE_MODE_SDH)
        {
            ...
            if (line_port_mode == WT_FLEXMUX_LINE_PORT_STM1)
            {
                ...
                for (stm1 = 0; stm1 < max_line_ports; stm1 += line_increment)
                {
                    ...
                    status = WPX_FRMR_SONET_SDH_PORT_SEC_B1_SetExcessiveTh (510 + stm1, 0, stm1, WPX_UFE_FRAMER_THRESHOLD_10E4);
                    WTI_FlexmuxCheckStatus ("WPX_FRMR_SONET_SDH_PORT_SEC_B1_SetExcessiveTh", status, __LINE__);

                    status = WPX_FRMR_SONET_SDH_PORT_SEC_B1_SetSignalDegradeTh (410 + stm1, 0, stm1, WPX_UFE_FRAMER_THRESHOLD_10E5);
                    WTI_FlexmuxCheckStatus ("WPX_FRMR_SONET_SDH_PORT_SEC_B1_SetSignalDegradeTh", status, __LINE__);

                    status = WPX_FRMR_SONET_SDH_PORT_LINE_B2_SetExcessiveTh (540 + stm1, 0, stm1, WPX_UFE_FRAMER_THRESHOLD_10E5);
                    WTI_FlexmuxCheckStatus ("WPX_FRMR_SONET_SDH_PORT_LINE_B2_SetExcessiveTh", status, __LINE__);

                    status = WPX_FRMR_SONET_SDH_PORT_LINE_B2_SetSigDegradeTh (440 + stm1, 0, stm1, WPX_UFE_FRAMER_THRESHOLD_10E6);
                    ...
                    for (stm0 = 0; stm0 < num_for_vc3_or_vc4; ++stm0)
                    {
                        ...
                        status = WPX_FRMR_SONET_SDH_HO_PATH_J1_SetEX (0, flexmux_id, &line_end_point, EX_J1);
                        WTI_FlexmuxCheckStatus ("WPX_FRMR_SONET_SDH_HO_PATH_J1_SetEX", status, __LINE__);
                        status = WPX_FRMR_SONET_SDH_HO_PATH_B3_SetExcessiveTh (0, flexmux_id, &line_end_point, WPX_UFE_FRAMER_THRESHOLD_10E4);
                        WTI_FlexmuxCheckStatus ("WPX_FRMR_SONET_SDH_HO_PATH_B3_SetExcessiveTh", status, __LINE__);

                        status = WPX_FRMR_SONET_SDH_HO_PATH_B3_SetSigDegradeTh (0, flexmux_id, &line_end_point, WPX_UFE_FRAMER_THRESHOLD_10E6);
            ...
            else if (line_port_mode == WT_FLEXMUX_LINE_PORT_STM4)
            {
                for (stm4 = 0; stm4 < max_line_ports; stm4 += line_increment)
                {
                    ...
                    status = WPX_FRMR_SONET_SDH_PORT_SEC_B1_SetExcessiveTh (510 + stm1, flexmux_id, stm4, WPX_UFE_FRAMER_THRESHOLD_10E4);
                    WTI_FlexmuxCheckStatus ("WPX_FRMR_SONET_SDH_PORT_SEC_B1_SetExcessiveTh", status, __LINE__);

                    status = WPX_FRMR_SONET_SDH_PORT_SEC_B1_SetSignalDegradeTh (410 + stm1, flexmux_id, stm4, WPX_UFE_FRAMER_THRESHOLD_10E5);
                    WTI_FlexmuxCheckStatus ("WPX_FRMR_SONET_SDH_PORT_SEC_B1_SetSignalDegradeTh", status, __LINE__);

                    status = WPX_FRMR_SONET_SDH_PORT_LINE_B2_SetExcessiveTh (540 + stm1, flexmux_id, stm4, WPX_UFE_FRAMER_THRESHOLD_10E5);
                    WTI_FlexmuxCheckStatus ("WPX_FRMR_SONET_SDH_PORT_LINE_B2_SetExcessiveTh", status, __LINE__);

                    status = WPX_FRMR_SONET_SDH_PORT_LINE_B2_SetSigDegradeTh (440 + stm1, flexmux_id, stm4, WPX_UFE_FRAMER_THRESHOLD_10E6);
                    WTI_FlexmuxCheckStatus ("WPX_FRMR_SONET_SDH_PORT_LINE_B2_SetSigDegradeTh", status, __LINE__);
                    ...
                    for (stm1 = 0; stm1 < 4; ++stm1)
                    {
                        ...
                        for (stm0 = 0; stm0 < num_for_vc3_or_vc4; ++stm0)
                        {
                            ...
                            status = WPX_FRMR_SONET_SDH_HO_PATH_J1_SetEX (0, flexmux_id, &line_end_point, EX_J1);
                            WTI_FlexmuxCheckStatus ("WPX_FRMR_SONET_SDH_HO_PATH_J1_SetEX", status, __LINE__);
                            status = WPX_FRMR_SONET_SDH_HO_PATH_B3_SetExcessiveTh (700, 0, &line_end_point, WPX_UFE_FRAMER_THRESHOLD_10E4);
                            WTI_FlexmuxCheckStatus ("WPX_FRMR_SONET_SDH_HO_PATH_B3_SetExcessiveTh", status, __LINE__);

                            status = WPX_FRMR_SONET_SDH_HO_PATH_B3_SetSigDegradeTh (701, 0, &line_end_point, WPX_UFE_FRAMER_THRESHOLD_10E6);
                            WTI_FlexmuxCheckStatus ("WPX_FRMR_SONET_SDH_HO_PATH_B3_SetSigDegradeTh", status, __LINE__);
                        }
                    }
                }
...
WP_S32 WTI_FlexmuxLinePortConfig (WP_U8 flexmux_id, WP_U8 line_port_id, WTI_flexmux_line_port_mode line_port_cfg)
{
    ...
    if ((flexmux_reg[flexmux_id].flexmux_mode == WPX_UFE_FRAMER_DEVICE_MODE_SONET) && (line_port_cfg != WT_FLEXMUX_LINE_PORT_OC3 && line_port_cfg != WT_FLEXMUX_LINE_PORT_OC12))
        WTI_FlexmuxTerminateOnError ("Invalid line_port_cfg!", 0);

    if ((flexmux_reg[flexmux_id].flexmux_mode == WPX_UFE_FRAMER_DEVICE_MODE_SDH) && (line_port_cfg != WT_FLEXMUX_LINE_PORT_STM1 && line_port_cfg != WT_FLEXMUX_LINE_PORT_STM4))
        WTI_FlexmuxTerminateOnError ("Invalid line_port_cfg!", 0);
...
WP_S32 WTI_FlexmuxDccEnable (WP_U8 flexmux_id, WP_U8 line_port_id, WP_U32 dcc_mode)
{
    WP_U8 status = 0;
...
WP_S32 WTI_FlexmuxLinePortIndexGet (WP_U32 ufe_line_index, WP_U32 flexmux_id)
{
    ...
    if (flexmux_reg[flexmux_id].flexmux_build_personality != WPX_UFE_FRAMER_BUILD_PERSONALITY_4_PLUS_4_OC3_OC12 &&
        ...
        flexmux_reg[flexmux_id].flexmux_build_personality != WPX_UFE_FRAMER_BUILD_PERSONALITY_1_PLUS_1_OC3_OC12 && flexmux_reg[flexmux_id].flexmux_build_personality != WPX_UFE_FRAMER_BUILD_PERSONALITY_2_PLUS_2_OC3 && flexmux_reg[flexmux_id].flexmux_build_personality != WPX_UFE_FRAMER_BUILD_PERSONALITY_4_PLUS_4_OC3)
    ...
    else if ((flexmux_reg[flexmux_id].flexmux_build_personality == WPX_UFE_FRAMER_BUILD_PERSONALITY_1_PLUS_1_OC3_OC12) || (flexmux_reg[flexmux_id].flexmux_build_personality == WPX_UFE_FRAMER_BUILD_PERSONALITY_2_PLUS_2_OC3) || (flexmux_reg[flexmux_id].flexmux_build_personality == WPX_UFE_FRAMER_BUILD_PERSONALITY_4_PLUS_4_OC3))
    {
        ...
        else if ((flexmux_reg[flexmux_id].flexmux_hw_config == WT_FLEXMUX_UFE_412_4_PORTS_OC3) || (flexmux_reg[flexmux_id].flexmux_hw_config == WT_FLEXMUX_UFE_412_2_PORTS_OC3) || flexmux_reg[flexmux_id].flexmux_hw_config == WT_FLEXMUX_UFE_412_4_PORTS_OC3_CARD_PROTECTION_MASTER || flexmux_reg[flexmux_id].flexmux_hw_config == WT_FLEXMUX_UFE_412_4_PORTS_OC3_CARD_PROTECTION_SLAVE)
        {
