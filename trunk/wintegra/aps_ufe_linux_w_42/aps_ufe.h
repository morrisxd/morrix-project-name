 ...
 *  File Name   : auto_protection_switch_ufe.h
 *  Version     : 1
 *  Date        : 20 Jan 2012
 *  Accompanies : TBD
 *****************************************************************************/
...
#define CLEAN_OUTPUT	0
#define DISABLE_PQBLOCK	0
#define REMOVE_DULL_STATS	0
...
#define QOS_ENABLE           1
#define HDLC_NUM			 1
#define APP_MAX_CHANNEL      HDLC_NUM
#define APP_MAX_DEV_HDLC     HDLC_NUM
#define APP_MAX_PORT_HDLC    HDLC_NUM 
#define APP_MAX_FLOW_AGG_HDLC HDLC_NUM
...
WP_port_pkt_limits pkt_limits = {APP_MAX_CHANNEL, APP_MAX_CHANNEL*APP_MAX_HDLC_PORTS, HDLC_NUM, APP_MAX_PORT_HDLC, APP_MAX_PORT_HDLC};
...
WP_CHAR dp_interface_val;
WP_CHAR config_choice;
...
WP_handle               h_flow_agg_hdlc[HDLC_NUM];
WP_handle               h_iw_sys_bridge1, h_iw_sys_bridge2;
WP_handle               h_iw_sys_pppsw;
WP_handle               h_learningflow_enet1;
WP_handle               h_bridge1_dfcflow1[HDLC_NUM][APP_MAX_HDLC_PORTS];
WP_handle               h_bridge2_dfcflow[HDLC_NUM][APP_MAX_HDLC_PORTS],h_bridge2_dfcflow_control,h_bridge2_dfcflow_lcp;
...
WP_handle               h_flow_agg_pppsw_link[HDLC_NUM];
...
WP_handle               h_hdlc_rx[APP_MAX_CHANNEL],h_hdlc_tx[HDLC_NUM];
WP_handle               pqblock_handle[HDLC_NUM];
