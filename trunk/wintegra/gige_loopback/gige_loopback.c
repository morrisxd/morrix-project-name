...
#ifndef _GIGE_LOOPBACK_C__
#define _GIGE_LOOPBACK_C__
...
WP_U32 FillAutomationArray (WP_CHAR * InputBuf, WP_CHAR * params_string,
                            WP_U32 demo_mode);
 ...
 *****************************************************************************/
#define START_SCHEDULER /*1*/0  /*Phenix */
/****************************************************************************
...
static char sendPacket1[40], sendPacket2[40], pollPacket1[40],
   pollPacket2[40];
 ...
 *****************************************************************************/
#if 0
extern WP_U32 dps_ProgramImage_WinFarm_0[];
extern WP_U32 dps_ProgramImage_WinFarm_1[];

extern WP_U32 dps_PC_Table_Init_WinFarm_0[];
extern WP_U32 dps_PC_Table_Init_WinFarm_1[];
#else
extern WP_U32 dps_ProgramImage[];
extern WP_U16 dps_PC_Table_Init[];
#endif
...
WP_context context[1] = {
   {7,                          /* qnodes */
    ...
    {
     /* WP_VB_PARAM = 0,                      */ {WP_BUS_PARAM,
                                                  APP_BANK_PARAM},
     /* WP_VB_PACKET,                         */ {WP_BUS_PACKET,
                                                  APP_BANK_PACKET},
     /* WP_VB_INTERNAL,                       */ {WP_BUS_INTERNAL,
                                                  APP_BANK_INTERNAL},
     /* WP_VB_HOST,                           */ {WP_BUS_HOST,
                                                  APP_BANK_HOST},
     /* WP_VB_INTQUEUE_DEBUG,                 */ {WP_BUS_HOST,
                                                  APP_BANK_HOST},
     /* WP_VB_TIMESTAMP,                      */ {WP_BUS_HOST,
                                                  APP_BANK_HOST},
     /* WP_VB_CAS,                            */ {WP_BUS_NONE, 0},
     /* WP_VB_TRANS_TSAT,                     */ {WP_BUS_NONE, 0},
     /* WP_VB_TPT,                            */ {WP_BUS_INTERNAL,
                                                  APP_BANK_INTERNAL},
     /* WP_VB_CW,                             */ {WP_BUS_INTERNAL,
                                                  APP_BANK_INTERNAL},
     /* WP_VB_ASU_TXQUEUE,                    */ {WP_BUS_PARAM,
                                                  APP_BANK_PARAM},
#ifndef WDS_SL
     /* WP_VB_STATISTICS,                     */ {WP_BUS_PACKET,
                                                  APP_BANK_PACKET},
#else
     /* WP_VB_STATISTICS,                     */ {WP_BUS_PARAM,
                                                  APP_BANK_PARAM},
#endif
     /* WP_VB_ATM_ADDLOOKUP,                  */ {WP_BUS_PARAM,
                                                  APP_BANK_PARAM},
     /* WP_VB_ATM_CPT_EBMT_EXTHEADER,         */ {WP_BUS_PARAM,
                                                  APP_BANK_PARAM},
     /* WP_VB_ETH_HDLC_CPT,                   */ {WP_BUS_PARAM,
                                                  APP_BANK_PARAM},
     /* WP_VB_FBP_BD,                         */ {WP_BUS_PARAM,
                                                  APP_BANK_PARAM},
#ifndef WDS_SL
     /* WP_VB_FBP_DATA,                       */ {WP_BUS_PACKET,
                                                  APP_BANK_PACKET},
     /* WP_VB_L2_BKGND,                       */ {WP_BUS_PACKET,
                                                  APP_BANK_PACKET},
     /* WP_VB_BRIDGE_LEARNING_DFC_PFMT        */ {WP_BUS_PACKET,
                                                  APP_BANK_PACKET},
#else
     /* WP_VB_FBP_DATA,                       */ {WP_BUS_PARAM,
                                                  APP_BANK_PARAM},
     /* WP_VB_L2_BKGND,                       */ {WP_BUS_PARAM,
                                                  APP_BANK_PARAM},
     /* WP_VB_BRIDGE_LEARNING_DFC_PFMT        */ {WP_BUS_PARAM,
                                                  APP_BANK_PARAM},
#endif
     /* WP_VB_IMA_MLPPP_STATE,                */ {WP_BUS_INTERNAL,
                                                  APP_BANK_INTERNAL},
     /* WP_VB_IMA_MLPPP_BUFFER,               */ {WP_BUS_HOST,
                                                  APP_BANK_HOST},
#ifndef WDS_SL
     ...
     /* WP_VB_IW_MFC_RULES,                   */ {WP_BUS_PACKET,
                                                  APP_BANK_PACKET},
#else
     /* WP_VB_HASH_IW_LPM_EMC,                */ {WP_BUS_PARAM,
                                                  APP_BANK_PARAM},
     /* WP_VB_IW_MFC_RULES,                   */ {WP_BUS_PARAM,
                                                  APP_BANK_PARAM},
#endif
     ...
     /* WP_VB_IW_MFCPT_DIFFSERV_UPPT_D        */ {WP_BUS_INTERNAL,
                                                  APP_BANK_INTERNAL},
#ifndef WDS_SL
     /* WP_VB_STATISTICS2,                    */ {WP_BUS_PACKET,
                                                  APP_BANK_PACKET},
     /* WP_VB_STATISTICS3,                    */ {WP_BUS_PACKET,
                                                  APP_BANK_PACKET},
#else
...
#ifndef WDS_SL
     /* WP_VB_MFC_INTERNAL,                   */ {WP_BUS_PACKET,
                                                  APP_BANK_PACKET},
#else
...
#if 0
    {dps_ProgramImage_WinFarm_0, dps_ProgramImage_WinFarm_1},
    {(void *) dps_PC_Table_Init_WinFarm_0, (void *) dps_PC_Table_Init_WinFarm_1},
#else
    {
...
WP_iw_agg_routing tx_binding[2] = {
   {
    ...
    /* prefix_length */ 14,
    /* multi_cong_prof  */ 0,
    /* prefix_header[16] */ {0x12, 0x34, 0x56, 0x78, 0x99, 0x99, 0x12,
                             0x34,
                             0x56, 0x78, 0x77, 0x77, 0x08, 0x00, 0x00, 0x00}
    ,
    /* new_ip_header[20]; */ {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                              0x00,
   ...
   ,
   {
    ...
    /* prefix_length */ 22,
    /* multi_cong_prof  */ 0,
    /* prefix_header[24] */ {0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00,
                             0x00,
                             0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0xaa,
                             0xaa,
...
WP_calendar_wheel calendar_cfg[2] = {
   {
    ...
    /* cwid */ WP_CW_ID_A,
                                /* min_ch_rate */ 150,
                                /* 64Kbps / 424 , MIN_CH_RATE */
                                /* max_ch_rate */ 117925
                                /* 50Mbps / 424 , MAX_CH_RATE */
    }
   ,
...
{
   sprintf (sendPacket1, "Send a test packet to enet %d",
            WT_ENET_INTERFACE_1 - WP_PORT_ENET1 + 1);
   sprintf (sendPacket2, "Send a test packet to enet %d",
            WT_ENET_INTERFACE_2 - WP_PORT_ENET1 + 1);
   sprintf (pollPacket1, "Poll for a packet on enet %d",
            WT_ENET_INTERFACE_1 - WP_PORT_ENET1 + 1);
   sprintf (pollPacket2, "Poll for a packet on enet %d",
            WT_ENET_INTERFACE_2 - WP_PORT_ENET1 + 1);
}
...
void InitDrivers ()
{
   ...
   status =
      WPU_PinMuxAllocateToPort (WP_PORT_asdfsdfsdfkENET1,
                                WPU_PIN_MUX_MODE_DEFAULT);
   terminate_on_error (status, "WPU_PinMuxAllocateToPort - Enet1");

   status =
      WPU_PinMuxAllocateToPort (WP_PORT_ENET3, WPU_PIN_MUX_MODE_DEFAULT);
...
void InitBoard ()
{
   ...
   *****************************************************************************/
   ...
   buffer_pool_1 =
      WP_PoolCreate (WP_WINPATH (0), WP_pool_iwbuffer, buffer_data);
 ...
 *****************************************************************************/
   ...
   iw_host_device =
      WP_DeviceCreate (iw_host_port, 0, WP_DEVICE_IW_HOST, NULL);
   ...
   *****************************************************************************/
   ...
   enet_tx_1 =
      WP_ChannelCreate (0x19, gbedev1, iw_qnode_1, WP_CH_TX, WP_ENET,
                        &ch_enet[0]);
   terminate_on_error (enet_tx_1, "WP_ChannelCreate() enet tx 1");

   enet_rx_1 =
      WP_ChannelCreate (0x1a, gbedev1, iw_qnode_1, WP_CH_RX, WP_ENET,
                        &ch_enet[0]);
   terminate_on_error (enet_rx_1, "WP_ChannelCreate() enet rx 1");

   enet_tx_2 =
      WP_ChannelCreate (0x29, gbedev2, iw_qnode_1, WP_CH_TX, WP_ENET,
                        &ch_enet[0]);
   terminate_on_error (enet_tx_2, "WP_ChannelCreate() enet tx 2");

   enet_rx_2 =
      WP_ChannelCreate (0x2a, gbedev2, iw_qnode_1, WP_CH_RX, WP_ENET,
                        &ch_enet[0]);
   ...
   status =
      WP_MemoryAvailable (WP_WINPATH (0), WP_BUS_INTERNAL, 0, &bytes);
   ...
   iw_ch_g1 =
      WP_ChannelCreate (0, host_device, iw_qnode_1, WP_CH_RX, WP_IW_HOST,
                        rx_ch);
   ...
   iw_sys =
      WP_IwSystemCreate (WP_WINPATH (0), WP_IW_TRANS_BRIDGING_MODE,
                         dm_sys);
   ...
   iw_agg_g1 =
      WP_IwFlowAggregationCreate (WP_WINPATH (0),
                                  WP_IW_TRANS_BRIDGING_MODE, tx_agg_h);
   ...
   status =
      WP_IwRxBindingCreate (enet_rx_1, iw_sys, iw_qnode_1, rx_bind_dm);
   terminate_on_error (status, "RxBindingCreate");

   rx_bind_dm[0].input_port = bport_g2;
   status =
      WP_IwRxBindingCreate (enet_rx_2, iw_sys, iw_qnode_1, rx_bind_dm);
   terminate_on_error (status, "RxBindingCreate");

   status =
      WP_IwTxBindingCreate (enet_tx_1, WP_IW_TX_BINDING,
                            &tx_bind_rx_ch[0]);
   terminate_on_error (status, "TxBindingCreate");

   status =
      WP_IwTxBindingCreate (enet_tx_2, WP_IW_TX_BINDING,
                            &tx_bind_rx_ch[0]);
   terminate_on_error (status, "TxBindingCreate");
...
void IwHostTxChannel (WP_handle flow_agg)
{
   ...
   iwhosttx_handle =
      WP_ChannelCreate (0x123456, iw_host_device, iw_qnode_1, WP_CH_TX,
                        WP_IW_HOST, &ch_config_iw_tx[0]);
   terminate_on_error (iwhosttx_handle,
                       "WP_ChannelCreate() iw host Tx channel");

#ifdef WP_HW_WINPATH2
   status = WP_ChannelEnable (iwhosttx_handle);
   terminate_on_error (status, "WP_ChannelEnable() iwhosttx_handle");
#endif
}

void iw_host_tx_data (WP_handle flow_agg_handle, WP_handle iwtx_handle,
                      WP_handle pool)
{
   WP_U32 /*i,j, */ k;
   WP_status status;
