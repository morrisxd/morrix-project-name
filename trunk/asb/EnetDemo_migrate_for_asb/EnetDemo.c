...
extern unsigned char wp3_getchar();

extern void WPE_DisplayEnetDeviceStat(WP_handle dev_enet);
extern void WPE_DisplayFlowAggStats(WP_handle agg);
extern void WPE_DisplayIWPortStats(WP_handle iw_port_handle);
extern void WPE_DisplayIWSystemStats(WP_handle port_handle);
 ...
 ***                                 DEFINES                                  ***
 *******************************************************************************/
#define WP_MAX_IW_PROGRAMMABLE_FILTERS 1
#define WP_MAX_IW_CLASSFICATION_RULES  1
#define WP_IW_DHCP_DFC_FILTER_MASK     0x80000000
#define RM_MAX_MULTICAST_MEMBER_QUANTITY    2400 // IGMP module dimension is 2400
#define WT_MAX_IW_FLOWS            8192
#define WT_MAX_BPORTS              2048
#define RM_MAX_MULTICAST_CHANNEL_QUANTITY	 1024
#define WT_MAX_IW_MC_GROUPS    (2*RM_MAX_MULTICAST_CHANNEL_QUANTITY)
#define WT_MAX_IW_MC_MEMBERS   (2*RM_MAX_MULTICAST_MEMBER_QUANTITY)
...
#define XPRIO_BACKGROUND_APPL           50  /*!< preemption: enabled  , roundrobin: enabled  */
#define T_PREEMPT       0x00000000   /* Preemptible */
#define T_TSLICE        0x00000002   /* Time-slicing enabled bit */

typedef enum
{	
	PIC_INTR0,   PIC_INTR1,   PIC_INTR2,   PIC_INTR3,
	PIC_INTR4,   PIC_INTR5,	  PIC_INTR6,   PIC_INTR7,
	PIC_INTR8,   PIC_INTR9,	  PIC_INTR10,  PIC_INTR11,
	PIC_INTR12,  PIC_INTR13,  PIC_INTR14,  PIC_INTR15,
	PIC_INTR16,  PIC_INTR17,  PIC_INTR18,  PIC_INTR19,
	PIC_INTR20,  PIC_INTR21,  PIC_INTR22,  PIC_INTR23,
	PIC_INTR24,  PIC_INTR25,  PIC_INTR26,  PIC_INTR27,
	PIC_INTR28,  PIC_INTR29,  PIC_INTR30,  PIC_INTR31,
	PIC_INTR32,  PIC_INTR33,  PIC_INTR34,  PIC_INTR35,	
	PIC_INTR36,  PIC_INTR37,  PIC_INTR38,  PIC_INTR39,
	PIC_INTR40,  PIC_INTR41,  PIC_INTR42,  PIC_INTR43,
	PIC_INTR44,  PIC_INTR45,  PIC_INTR46,  PIC_INTR47,
	PIC_INTR48,  PIC_INTR49,  PIC_INTR50,  PIC_INTR51,
	PIC_INTR52,  PIC_INTR53,  PIC_INTR54,  PIC_INTR55,	
	PIC_INTR56,  PIC_INTR57,  PIC_INTR58,  PIC_INTR59,
	PIC_INTR60,  PIC_INTR61,  PIC_INTR62,  PIC_INTR63,
	PIC_INTR64,  PIC_INTR65,  PIC_INTR66,  PIC_INTR67,
	PIC_INTR68,  PIC_INTR69,  PIC_INTR70,  PIC_INTR71,
	PIC_INTR72,  PIC_INTR73,  PIC_INTR74,  PIC_INTR75,	
	PIC_INTR76,  PIC_INTR77,  PIC_INTR78,  PIC_INTR79,
	PIC_INTR80,  PIC_INTR81,  PIC_INTR82,  PIC_INTR83,
	PIC_INTR84,  PIC_INTR85,  PIC_INTR86,  PIC_INTR87,
	PIC_INTR88,  PIC_INTR89,  PIC_INTR90,  PIC_INTR91,
	PIC_INTR92,  PIC_INTR93,  PIC_INTR94,  PIC_INTR95,	
	PIC_INTR96,  PIC_INTR97,  PIC_INTR98,  PIC_INTR99,
	PIC_INTR100, PIC_INTR101, PIC_INTR102, PIC_INTR103,
	PIC_INTR104, PIC_INTR105, PIC_INTR106, PIC_INTR107,
	PIC_INTR108, PIC_INTR109, PIC_INTR110, PIC_INTR111,
	PIC_INTR112, PIC_INTR113, PIC_INTR114, PIC_INTR115,	
	PIC_INTR116, PIC_INTR117, PIC_INTR118, PIC_INTR119,
	PIC_INTR120, PIC_INTR121, PIC_INTR122, PIC_INTR123,
	PIC_INTR124, PIC_INTR125, PIC_INTR126, PIC_INTR127,
	PIC_INTR128, PIC_INTR129, PIC_INTR130, PIC_INTR131,
	PIC_INTR132, PIC_INTR133, PIC_INTR134, PIC_INTR135,	
	PIC_INTR136, PIC_INTR137, PIC_INTR138, PIC_INTR139,
	PIC_INTR140, PIC_INTR141, PIC_INTR142, PIC_INTR143,
	PIC_INTR144, PIC_INTR145, PIC_INTR146, PIC_INTR147,
	PIC_INTR148, PIC_INTR149, PIC_INTR150, PIC_INTR151,
	PIC_INTR152, PIC_INTR153, PIC_INTR154, PIC_INTR155,	
	PIC_INTR156, PIC_INTR157, PIC_INTR158, PIC_INTR159
} pic_intr_num_type;
...
// Auxillary Functions
void WPE_CLI (void);
void WPE_CLI_input (char InputBuf[32]);
void WPE_ShowAvailableBusesMemory (void);
void WPE_RegisterLogCbFunc (void);
void terminate_on_error_EnetDemo (WP_handle handle, WP_CHAR * s);
...
extern unsigned long xt_start (unsigned long task_id,
                               unsigned long mode,
                               void (*start_address) (void),
                               unsigned long task_args[4]);
extern unsigned long xt_create (char name[4],
                         unsigned long priority,
                         unsigned long sup_stack,
                         unsigned long usr_stack,
                         unsigned long flags,
                         unsigned long *task_id);

extern unsigned long xtm_wkafter (unsigned long timeout);

void app_overrun_callback (WP_U32 wpid, WP_U32 queue_id, WP_U32 overrun_count)
{
   wp3_uart_printf ("Overrun happenes: wpid(%2d), queue_id(%2d), overrun_cnt(%6d)", 
...
void enable_interrupts_as_asb(void);
void WT_lxFwd_SimulateInterrupts_ISR(u_int32 dev_num)
{
        u_int32 iii = 0;
     iii = dev_num;
...
void enable_interrupts_as_asb(void)
{
(void)board_set_intr_handler(60, WT_lxFwd_SimulateInterrupts_ISR, 0);
(void)board_set_intr_handler(61, WT_lxFwd_SimulateInterrupts_ISR, 0);
(void)board_set_intr_handler(62, WT_lxFwd_SimulateInterrupts_ISR, 0);
(void)board_set_intr_handler(63, WT_lxFwd_SimulateInterrupts_ISR, 0);

    /* mask interrupt of overrun interrupts, each for an WMM interrupt queue */
    (void)board_mask_intr(54);
    (void)board_mask_intr(55);
    (void)board_mask_intr(56);
    (void)board_mask_intr(57);

    /* mask interrupt of bus error interrupts, each for an SIU, SIU1:param, SIU2:packet, SIU3:internal, SIU3I:RIF */ 
    (void)board_mask_intr(8);
    (void)board_mask_intr(9);
    (void)board_mask_intr(10);
    (void)board_mask_intr(11);
    (void)board_mask_intr(12);

    (void)board_unmask_intr(60);
    (void)board_unmask_intr(61);
    (void)board_unmask_intr(62);
    (void)board_unmask_intr(63);
...
//----- Basic Functionality POS+Enet+Host ----//
   ...
   terminate_on_error_EnetDemo (status, "WP_DriverInit()");
   ...
   status = WP_SysCommit ();   
   terminate_on_error_EnetDemo (status, "WP_SysCommit");
...
//-------- Optional Functionality ---------//
   ...
   terminate_on_error_EnetDemo (status,
                       "WP_ControlRegister WP_FORWARD_RULE_FIND_ALL ");


   //status = WP_ControlRegister(WP_EVENT_IW_LEARNING_QUEUE, &WPE_LearningIST);
   //terminate_on_error_EnetDemo(status, "WP_ControlRegister WP_EVENT_IW_LEARNING_QUEUE");
      ...
      terminate_on_error_EnetDemo(status, "WP_ControlRegister WP_EVENT_RX_INDICATE ");


      status = WP_ControlRegister(WP_EVENT_QUEUE_OVERRUN, 
                                       &app_overrun_callback);
      terminate_on_error_EnetDemo(status, "WP_ControlRegister WP_EVENT_QUEUE_OVERRUN");
...
//--------------------------------------//
   ...
   terminate_on_error_EnetDemo (status, "WP_IwSystemBuild");
   enable_interrupts_as_asb ();
   ...
   WPE_EnableSystem ();
...
#if 1
	wp3_uart_printf ("before lock init\n");

	WPL_LockKeyInit (WPL_THREAD_LOCK_KEY, &eoam_lock);
	wp3_uart_printf ("after lock init\n");
	...
	wp3_uart_printf ("press any to to start new thread\n");
	ch = getchar ();
#if 0
	status = WPL_ThreadInit(&learning_thread_id, LearningPoll, 0);
	terminate_on_error_EnetDemo (status , "WPL_ThreadInit() learning");
	wp3_uart_printf ("after Threadinit\n");
#else
    ret = xt_create("LearningPoll", XPRIO_BACKGROUND_APPL, 4096, 0L, 0L, &task_id);
    if(ret != 0 )
    {
        wp3_uart_printf ("error in create  task_id\n"); 
        return ;
    }
    
    ret = xt_start(task_id, T_PREEMPT|T_TSLICE, LearningPoll, NULL);
    if(ret!=0)
    {
       wp3_uart_printf ("error in start task  LearningPoll\n"); 
       return ;
    }
#endif
...
#else
WP_int_queue_table       int_queue_tables = {{{100, 1}, {100, 1}, {100, 1}, {100, 1}},{0, 0}};
...
WP_iw_global max_iw =
{
   /* max_iw_aggregations */              WT_MAX_IW_FLOWS,
   /* max_r_iw_systems;*/                 0,
   /* max_s_iw_systems;*/                 0,
   /* max_b_iw_systems;*/                 1,
   /* max_m_iw_systems;*/                 0,
   ...
   {  /*policer_mode;*/                    WP_IW_POLICER_DISABLE,
      /*statistics_bundle_stat_mode(For V1 policer and congestion, must be enabled)*/     WP_IW_STATISTICS_BUNDLE_STAT_ENABLE,
   ...
   /* max_iw_ports */                      WT_MAX_BPORTS,
   /* max_iw_mc_groups*/                  WT_MAX_IW_MC_GROUPS,
   /* max_nat_systems*/                   0,
   /* max_iw_second_aggregations*/       11,
   /* iw_comp_limits*/                     NULL,
   /* max_iw_mc_members */               WT_MAX_IW_MC_MEMBERS,
   /* max_iw_programmable_filters */     WP_MAX_IW_PROGRAMMABLE_FILTERS,
   /* max_iw_policers */                  0,
   /*max_dscpmt*/                      0,
   /*max_wred_bindings*/                0,
   /*tcm_policer_limits*/
   ...
   /*max_flow_rule_stat_tables*/             0,
   /*max_indirect_action_tables*/             0,
   /*WP_iw_lpm_bridging_limits*/
   {
       /*max_ipv4_lpm_bridging_iw_systems*/ 0,
       /*max_ipv4_bridging_flows*/           0
   },
   /*WP_iw_brigding_time_stamp_info*/
   {
       /*time_stamp_offset*/               0,
       /*time_stamp_resolution*/            0
   },
   /*iwgp_bkgnd_fifo_size*/     4096
}; /* max_iw */

/* An array of one WP_context structure for each WinPath */
WP_context wpsys_context =
{
   128, /* qnodes */
   /* the first four assignments are mandatory bus assignments */
    /* we add adsl/vdsl support in this struct  YHL */
    {
           ...
           /* WP_VB_CONGESTION_TABLE,               */{WP_BUS_PARAM,APP_BANK_PARAM},
           ...
           /* WP_VB_PECS_GLOBAL,             */{WP_BUS_PARAM, APP_BANK_PARAM},                     
           /* WP_VB_ENET_10G_LONG_PKT,             */{WP_BUS_NONE, 0},               
           /* WP_VB_G999_STREAM,             */{WP_BUS_PARAM, APP_BANK_PARAM},               
           /* WP_VB_G999_STREAM_STATISTICS,             */{WP_BUS_PARAM, APP_BANK_PARAM},    
           /* WP_VB_FMU_FIFO_TO_CHANNEL_NUMBER,             */{WP_BUS_PARAM, APP_BANK_PARAM},
           /* WP_VB_IPWORT_EXT,*/                   {WP_BUS_PARAM, APP_BANK_PARAM},
           /* WP_VB_IW_GPMT_TABLE,*/                {WP_BUS_PARAM, APP_BANK_PARAM}, 
           /* WP_VB_EMPHY_PORT_LOOKUP,*/            {WP_BUS_NONE, 0}, 
           /* WP_VB_IW_MLPB_TABLE,*/                 {WP_BUS_NONE, 0}, 
           /* WP_VB_MLCE_CD,*/                       {WP_BUS_NONE, 0}, 
    },
   ...
   &int_queue_tables,      /* Interrupt queue tables */
   128,             /* Mixumum number of pools */

   &atm_data,                   /* ATM global parameters */
   &max_iw,                 /* Interworking global parameters */
}; /* wpsys_context */
...
#else
   status = WP_SysInit (WP_WINPATH (0), &wpsys_context);

#endif

   terminate_on_error_EnetDemo (status, "WP_SysInit");
} 
...
void WPE_InitHWCards ()
{
   ...
   terminate_on_error_EnetDemo (status, "WPX_CONFIGURE_2UPI_1XGI_10SGMII()");
#else
    status = WPX_BoardConfigure(0, WPX_CONFIGURE_6SGMII1000_3GMII_2S3MII_1SGMII2500);
    terminate_on_error_EnetDemo(status, "WPX_BoardConfigure()");
...
// loopback here will cause system stuck
   status = WPX_BoardSerdesInit (0, WP_PORT_ENET2, WPX_SERDES_NORMAL);
#endif

   terminate_on_error_EnetDemo (status, "WPX_BoardSerdesInit 7()");
#if 0
   status = WPX_BoardSerdesInit (0, WP_PORT_ENET8, WPX_SERDES_NORMAL);
#else
   status = WPX_BoardSerdesInit (0, WP_PORT_ENET1, WPX_SERDES_NORMAL);
#endif
   terminate_on_error_EnetDemo (status, "WPX_BoardSerdesInit 8()");
}
...
//   {
//      {/* n_buffers */ (1200*4),// APP_HOST_BUFFER_NUM,
//         /* offset */    0,
//         /* size */      /*APP_HOST_BUFFER_SIZE*/2048,
//         /* pad */       0,
//         /* bus*/WP_BUS_PARAM,/* This should really be WP_BUS_PARAM? */
//        /* bank */ APP_BANK_PARAM
//      }
//   };
...
#define IW_ADJUNCT_POOL_BUFFER_SIZE  2000
#define APP_IW_BUFFER_SIZE 2048

   static WP_pool_buffer_data buffer_data_2048[1] =
   {
        {
            /* n_buffers */ IW_ADJUNCT_POOL_BUFFER_SIZE,
            /* offset */ 64,
            /* size */ (APP_IW_BUFFER_SIZE),
            /* pad */ 0,
            /* bus */ WP_BUS_PARAM,  /* WP_BUS_HOST, This should really be WP_BUS_PARAM? */
            /* bank */ APP_BANK_PARAM
         }
   };


   adjunct_buffer_config.offset = 64;
...
#endif                     
   terminate_on_error_EnetDemo (adjunct_buffer_pool, "WP_PoolCreate()");
wp3_uart_printf ("#################################################\n");
wp3_uart_printf ("#################################################\n");
wp3_uart_printf ("#################################################\n");
wp3_uart_printf ("#################################################\n");
...
wp3_uart_printf ("#################################################\n");
wp3_uart_printf ("*************************************************\n");
wp3_uart_printf ("buildtimes: date(%s)time(%s)\n", __DATE__, __TIME__);
...
// #error !!!fuck!!!
   ...
   terminate_on_error_EnetDemo (iw_qnode, "WP_QNodeCreate()");
} 
...
void WPE_CreateHostQnode ()
{
   ...
   terminate_on_error_EnetDemo (pool_host, "WP_PoolCreate() pool_host");

   // Create the pointers to buffers - rings
   pool_ring_host =
      WP_PoolCreate (WP_WINPATH (0), WP_pool_ring, &ring_host_config);
   terminate_on_error_EnetDemo (pool_ring_host, "WP_PoolCreate() pool_ring_host");
   ...
   terminate_on_error_EnetDemo (qnode_host, "WP_QNodeCreate() qnode_host");
#endif
} 
...
void WPE_CreateMultiCastQnode ()
{
   ...
   qnode_mc = WP_QNodeCreate (WP_WINPATH (0), WP_QNODE_IW_MCQ, /* WP_QNDE_IW_MCQ is the key point */
                              &iw_mc_qn_config);
   terminate_on_error_EnetDemo (qnode_mc, "WP_QNodeCreate MCQ()");
#endif
} 
...
void WPE_CreateIWBridgeSystem ()
{
   ...
   terminate_on_error_EnetDemo (iw_sys, " WP_IwSystemCreate - Bridging");
} 
...
void WPE_EnableSystem ()
{
   ...
   terminate_on_error_EnetDemo (status, "WP_SysPsuEnable()");
   ...
   for (i = 0; i < NUM_OF_FAST_ENET_TX_CHANNELS; i++)
   {
      ...
      terminate_on_error_EnetDemo (status, "WP_ChannelEnable() tx_gbe");
   }
   status = WP_ChannelEnable (rx_gbe_channel);
   terminate_on_error_EnetDemo (status, "WP_ChannelEnable() rx_gbe");
   ...
   terminate_on_error_EnetDemo (status, "WP_PortEnable Enet");

   /* Enable the Enet Device */
   status = WP_DeviceEnable (dev_enet, WP_DIRECTION_DUPLEX);
   terminate_on_error_EnetDemo (status, "WP_DeviceEnable Enet");
...
void WPE_CreateHostPortDevice ()
{
   ...
   terminate_on_error_EnetDemo (port_host, "WP_PortCreate() HOST");
   dev_host = WP_DeviceCreate (port_host, 0, WP_DEVICE_IW_HOST, NULL);
   terminate_on_error_EnetDemo (dev_host, "WP_DeviceCreate() Host");
} 
...
void WPE_CreateHostIwRxChannel ()
{
   ...
   terminate_on_error_EnetDemo (rx_host_channel,
...
void WPE_CreateHostIwTxChannel ()
{
   ...
   terminate_on_error_EnetDemo (tx_host_channel,
...
void WPE_CreateHostTermFlowAgg ()
{
   ...
   agg_host =
      WP_IwFlowAggregationCreate (WP_WINPATH (0),
                                  ...
                                  &agg_host_config);
   terminate_on_error_EnetDemo (agg_host, "WPE_CreateHostTermIwFlowAgg() Host");
}  
...
void WPE_CreateIwBportHost ()
{
   ...
   terminate_on_error_EnetDemo (bport_host, " WPE_CreateIwBportHost ");
   ...
   status =
      WP_IwFlowAggregationModify (agg_host,
                                  ...
                                  &agg_host_config);
   terminate_on_error_EnetDemo (status, "WP_IwFlowAggregationModify");
} 
...
void WPE_CreateFastEnetPortDevice ()
{
...
#else
      WP_PortCreate (WP_WINPATH (0), WP_PORT_ENET2, &enet_port_config);
#endif
   terminate_on_error_EnetDemo (port_enet, "WP_PortCreate() Fast ENET");
   ...
   dev_enet =
      WP_DeviceCreate (port_enet, WP_PHY (0), WP_DEVICE_ENET,
                       &enet_dev_config);
   terminate_on_error_EnetDemo (dev_enet, "WP_DeviceCreate() Fast Enet");
   ...
   terminate_on_error_EnetDemo (status, "WP_DeviceModify () Fast Enet");
   wp3_uart_printf ("DeviceModify() ok\n");
#endif
} 
...
void WPE_CreateHierEnetPortDevice ()
{
...
#endif
   terminate_on_error_EnetDemo (port_hier_enet,
   ...
   dev_hier_enet =
      WP_DeviceCreate (port_hier_enet, WP_PHY (0),
                       WP_DEVICE_ENET, &hier_enet_dev_config);
   terminate_on_error_EnetDemo (dev_hier_enet,
...
void WPE_CreateFastEnetIwBport ()
{
   ...
   terminate_on_error_EnetDemo (bport_enet, " WPE_CreateIwBportEnet Fast");
}  
...
void WPE_CreateHierEnetIwBport ()
{
   ...
   terminate_on_error_EnetDemo (bport_hier_enet,
...
void WPE_CreateFastEnetFlowAgg ()
{
...

   {
      ...
      agg_enet[i] =
         WP_IwFlowAggregationCreate (WP_WINPATH (0),
                                     ...
                                     &agg_enet_config);
      terminate_on_error_EnetDemo (agg_enet[i],
   ...
   agg_enet_change_mac =
      WP_IwFlowAggregationCreate (WP_WINPATH (0),
                                  WP_IW_VLAN_AWARE_BRIDGING_MODE,
                                  &agg_enet_config);
   terminate_on_error_EnetDemo (agg_enet_change_mac,
   ...
   for (i = 0; i < NUM_OF_L1_GROUP /* 1 */ ; i++)
   {
      for (j = 0; j < NUM_OF_L2_GROUP /* 4 */ ; j++)
      {
              ...
              k++)
         {
            ...
            terminate_on_error_EnetDemo (agg_hier_enet[i][j]
                                [k],
...
void WPE_CreateFastEnetRxTxBinding ()
{
...

   {
      ...
      terminate_on_error_EnetDemo (status, "WP_IwTxBindingCreate Fast");
   }
}
   ...
   for (i = 0; i < NUM_OF_L1_GROUP; i++)
   {
      for (j = 0; j < NUM_OF_L2_GROUP; j++)
      {
         for (k = 0; k < NUM_OF_HIER_ENET_FAS_PER_L2; k++)
         {
            ...
            terminate_on_error_EnetDemo (status, "WP_IwTxBindingCreate Hier");
         }
      }
   }
}
...
void WPE_CreateFastEnetRxTxChannel ()
{
   ...
   terminate_on_error_EnetDemo (rx_gbe_channel, "WP_Channel_Create() Fast RX");
...

   {
      ...
      terminate_on_error_EnetDemo (tx_gbe_channel[i],
...
void WPE_CreateHierHWEnetRxTxChannel ()
{
   ...
   terminate_on_error_EnetDemo (rx_gbe_hier_channel,
   ...
   for (i = 0; i < NUM_OF_L1_GROUP /* 1 */ ; i++)
   {
      for (j = 0; j < NUM_OF_L2_GROUP /* 4 */ ; j++)
      {
         ...
         {
	    wp3_uart_printf ("create tx_gbe_hier_channel, i[%d]j[%d]k[%d]\n",i,j,k);
            ...
            tx_gbe_hier_channel[i][j][k] = WP_ChannelCreate (0x11+k,
				...
				&hier_enet_ch_config);
#endif
            terminate_on_error_EnetDemo (tx_gbe_hier_channel[i][j][k],
...
void WPE_CreateL1FMUGroups (void)
{
...

   {
      ...
      terminate_on_error_EnetDemo (l1_group_hier[entry],
                          "WP_ShapingGroupCreate l1_hier");
      status = WP_ShapingGroupEnable (l1_group_hier[entry]);
      terminate_on_error_EnetDemo (status, "WP_ShapingGroupEnable l1_hier");
   }
}
void WPE_CreateL2FMUGroups (void)
{
...
#error USE_SOCKET_SHOULD_NOT_BE_DEFINED
   ...
   terminate_on_error_EnetDemo (block_handle, "WP_ShapingBlockCreate error");
...
#endif
   {
      ...
      {
	wp3_uart_printf ("now it is i(%d), entry(%d)\n", i, entry);
#if USE_SW_CHANNELS
	...
	enet_group_l2_config.block_level = entry;
         ...
         terminate_on_error_EnetDemo (l2_group_hier[i][entry],
                             "WP_ShapingGroupCreate l2_hier");
         status = WP_ShapingGroupEnable (l2_group_hier[i][entry]);
         terminate_on_error_EnetDemo (status, "WP_ShapingGroupEnable l2_hier");
      }
   }
}
...
void WPE_PolicerInit ()
{
   ...
   status =
      WP_ModuleInit (WP_SYSHANDLE (0), WP_WDDI_MODULE_POLICER,
                     &policer_module_cfg);
   terminate_on_error_EnetDemo (status, "WP_ModuleInit Policer");
}
void WPE_CreateSchedulingUnit (void)
{
   WP_status status;
   ...
   terminate_on_error_EnetDemo (status, "WP_SysSchedulerCreate()");
   wp3_uart_printf ("PSU_MODE On\n");
   status =
      WP_FeatureInit (WP_WINPATH (0), WP_FEATURE_PSU, &feature_psu_config);
   terminate_on_error_EnetDemo (status, "WP_FeatureInit-PSU");
} 
...
void WPE_CreateDedicatedFlowAgg ()
{
   ...
   terminate_on_error_EnetDemo (flow_agg_dedicated[i],
...
// -> Enet
   ...
   terminate_on_error_EnetDemo (status, "WP_IwMacAddressInsert() to Enet");
...
/* Filled values and their default values */
   ...
   terminate_on_error_EnetDemo (status, "WPE_LearningEvent()");
...

   {
      ...
      /*wp3_uart_printf("MAC WPE_LearningEvent SRC = ");
         for (j=0;j<6;j++) {
         wp3_uart_printf("0x%x ",learning_queue[i].mac[j]);
         }
...
//       terminate_on_error_EnetDemo(mc_group_handle[i], "WP_IwMcGroupCreate()");
//    }
...
//       terminate_on_error_EnetDemo(mc_agg_handle[i], "WP_IwFlowAggregationCreate() MC");
//    }
...
//       terminate_on_error_EnetDemo(mc_member_handle[i], "WP_IwMcMemberAdd() ");
//    }
// }
...
//    terminate_on_error_EnetDemo(mc_dummy_bport,"WP_IwPortCreate() mc dummy bport");
// }
void WPE_AddBasicFilters (void)
{
   ...
   terminate_on_error_EnetDemo (emc_filter_handle[0], "WP_IwClassFilterAdd");
   ...
   terminate_on_error_EnetDemo (mfc_filter_handle, "WP_IwClassFilterAdd");
...
void WPE_AddBasicRules (void)
{
   ...
   terminate_on_error_EnetDemo (flow_rule_handle[0][0],
...
//   sprintf(dfc_rule,  "n;n;n;n;n;n;n;n;0x.0.0.22.22.22;");
   ...
   flow_rule_handle[1][0] =
      WP_IwFlowAdd (iw_sys, WP_FLOW_CLASS_RULE, &class_cfg);
   terminate_on_error_EnetDemo (flow_rule_handle[1][0],
                       "WP_IwFlowAdd - Basic Rules");
...
//   sprintf(dfc_rule,  "n;n;n;n;n;n;n;n;0x.0.0.22.22.22;");
   ...
   flow_rule_handle[1][1] =
      WP_IwFlowAdd (iw_sys, WP_FLOW_CLASS_RULE, &class_cfg);
   terminate_on_error_EnetDemo (flow_rule_handle[1][1],
                       "WP_IwFlowAdd - Basic Rules");
...
void WPE_Receive_HostData_IRQ (WP_tag tag, WP_U32 event, WP_U32 info)
{
   ...
   g_callback ++;
         if (0 == (iii % 5000))
         {
            wp3_uart_printf ("iii(%6d), callback(%6d)\r", iii, g_callback);
         }
...
WP_U32 i;
...

   {
...

      {
         ...
         terminate_on_error_EnetDemo (status, "WP_HostReceive Error()");
   }
   p_got ++;
#define DISPLAY_MATRIX  (50)
   ...
   {
      wp3_uart_printf ("Receive Packet (%10d)\r", p_got);
   }
#endif
   ...
   {
      if(i%16 == 0) wp3_uart_printf("\n");
      wp3_uart_printf("0x%02x ", data_unit.segment->data[i]);
   }
   ...
   terminate_on_error_EnetDemo (status, "WP_PoolFree ()");
...
void WPE_IWSendReceive (WP_U32 packets, WP_U8 dst_mac[])
{
   ...
   /* status = WP_ChannelQDepth(tx_hdlc_channel_iw[1], &qdepth);
      ...
      wp3_uart_printf("ChannelQDepth = %d\n",qdepth);
    */
   for (j = 0; j < packets; j++)
...
//    WP_U32 i;
   ...
   wp3_uart_printf ("Receive Packet\n");
                        ...
                        WP_U8 dst_mac[])
{
...

   {
      ...
      {
         wp3_uart_printf ("WPE_SendHostData: adjanct pool is empty\t");
         return;
      }
...
//       if (segment.data == 0) {
//          wp3_uart_printf("WPE_SendHostData: pool_host is empty\t");
//          return;
//       }
//       segment.pool_handle= pool_host;
   ...
   {
      wp3_uart_printf ("WP_HostSend FIFO Put failed\n");
   }
...

   {
      ...
      terminate_on_error_EnetDemo (status, "WP_PoolFree (iw_qnode,segment.data)()");
   }

   else
      terminate_on_error_EnetDemo (status, "WP_HostSend ()");
   return;
}
...
void WPE_ShowForwardingRules (void)
{
   ...
   terminate_on_error_EnetDemo (status, "WP_IwForwardingRuleFindAll()");
} 
...
void WPE_DisplayForwardingRule (WP_U32 * l2_forward_rule)
{
   ...
   for (j = 0; j < 6; j++)
      wp3_uart_printf ("%.2x", forward_rule_ptr->mac[j]);
   wp3_uart_printf ("\t");
   wp3_uart_printf ("0x%x\t", forward_rule_ptr->vlan_id);
   wp3_uart_printf ("0x%x\t", forward_rule_ptr->bport_tag);
   wp3_uart_printf ("0x%x\t", forward_rule_ptr->aggregation);
...
void WPE_CLI (void)
{
...

   {
      ...
      wp3_uart_printf
         ("       All    control : \n \t\t\tc-disable/enable thread)\n");

#if 0
      gets (InputBuf);
#else
	do {
      InputBuf[0] = wp3_getchar();
	}
	...
	wp3_uart_printf ("agg_enet_change_mac statics\n");
         WPE_DisplayFlowAggStats (agg_enet_change_mac);
	wp3_uart_printf ("agg_hier_enet statics\n");
	...
	if (1 == threadStop)
	{
		wp3_uart_printf("disable thread now\n");
		threadStop = 0;
	} else {
		wp3_uart_printf ("enable thread now\n");
		threadStop = 1;
	}
	break;
      case 'a':
...
void WPE_RegisterLogCbFunc ()
{
   ...
   terminate_on_error_EnetDemo (status, "WP_ControlRegister() ErrorIndicateEvent");
...
#ifdef DEBUG_PRINT
      wp3_uart_printf ("Handle/Status returned from %s is 0x%x \n", s, handle);
...
void LearningPoll(void)
{
  ...
  wp3_uart_printf ("task LearningPoll begin \r\n"); 
	...
	WPL_IntConnect(0, WPL_SgmiiAn, NULL, 
        ...
        board_set_intr_handler( PIC_INTR53, 
           (void (*)(unsigned long dev_num))WPI_HwWinnetSgmiiAnProceed, 
                0); //45+8
#endif
...
////////////////////////////////////////////////////////
		...
		if (WP_ENET_SGMII_AN == interface_mode)
		{
			...
			WPL_IntEnable (0, WPL_SgmiiAn);
            		...
            		WPL_Delay(DELAY_COUNT);
#endif
			wp3_uart_printf ("enable SgmiiAn interrupt\n");
		} else {
#if 0
			WPL_IntDisable (0, WPL_SgmiiAn);
            		...
            		WPL_Delay(DELAY_COUNT);
#endif
			wp3_uart_printf ("disable SgmiiAn interrupt\n");
		}
//		WPL_Lock (WPL_THREAD_LOCK_KEY, &eoam_lock);

		wp3_uart_printf ("polling again(%d), enter to show the MENU\n", 
				iii++);
		status = WP_DeviceDisable(dev_enet,WP_DIRECTION_DUPLEX);
   		terminate_on_error_EnetDemo (status, "WP_DeviceDisable");
		status = WP_PortDisable(port_enet, WP_DIRECTION_DUPLEX);
   		terminate_on_error_EnetDemo (status, "WP_PortDisable");

		status = WP_PortModify(port_enet, WP_PORT_MOD_ENET_INTERFACE_MODE, &my_enet_port_config);
   		terminate_on_error_EnetDemo (status, "WP_PortModify");
