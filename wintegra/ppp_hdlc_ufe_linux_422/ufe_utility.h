...
/*****************************************************************************
 *  Application : HDLC/PPP over IP/MPLS UFE
...
WUFE_phy ufe4_phy_cfg = {
	/* struct_id         */ WUFE_STRUCT_PHY_HDLC,
	/* rx_fifo_param     */ {
		/* fifo_max_size     */ 4,
		/* priority_table    */ 0
	},
	...
	/* type          */ {
		/* hdlc             */ {
			/* rx_frame_include_crc_mode*/ WUFE_PHY_HDLC_CRC_DISABLE,
			/* rx_frame_crc_size        */ WUFE_PHY_HDLC_CRC_16,
			/* tx_frame_include_crc_mode*/ WUFE_PHY_HDLC_CRC_DISABLE,
			/* tx_frame_crc_size        */ WUFE_PHY_HDLC_CRC_16,
			/* tx_no_flag_between_frames*/ WUFE_PHY_HDLC_TX_FLAGS_BETWEEN_FRAMES,
			/* tx_min_flag_num          */ 1,
			/* tx_underrun_i            */ WUFE_PHY_ATM_TX_UNDERRUN_INT_DISABLE
		}
	}
};
...
WUFE_system ufe4_system_cfg = {
	/* max_line_number     */ MAX_UFE_LINES,
	/* max_phy_number      */ MAX_UFE_LINES,
	/* emphy_global        */ {
