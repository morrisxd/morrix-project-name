...
#ifndef FLEXMUX_UTIL_H
#define FLEXMUX_UTIL_H
...
typedef struct
{
    ...
    WTI_Flexmux_line_port_registry
        line_ports_reg[WTI_MAX_LINE_PORTS_PER_FLEXMUX_DEVICE];
} WTI_Flexmux_device_registry;

WTI_Flexmux_device_registry
    flexmux_reg[WTI_MAX_FLEXMUX_DEVICES_SUPPORTED_BY_DRIVER];
...
WUFE_status WPX_FRMR_PM_SonetSdhPortStorage (void *space,
                                             WP_U32 element_type);
WUFE_status WPX_FRMR_PM_SonetSdhHOPathStorage (void *space,
                                               WP_U32 element_type);
WUFE_status WPX_FRMR_PM_SonetSdhLOPathStorage (void *space,
                                               WP_U32 element_type);
